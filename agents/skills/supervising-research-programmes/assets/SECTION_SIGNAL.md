...
GROUNDING_LATENCY_MS: <nonnegative-integer-or-NULL>
KNOWN_DUPLICATE_REJECTION_COUNT: <nonnegative-integer>
INVALID_MEASUREMENT_RATE: <invalid measurement receipts / terminal measurement receipts-or-NULL>
STALE_WORK_COUNT: <nonnegative-integer>
SCALE_RELEASE_COUNT: <nonnegative-integer>
...
UTILIZATION_DIAGNOSTIC_ONLY: YES
