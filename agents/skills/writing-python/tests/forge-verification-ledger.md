...
One typed routing row distinguishes Python implementation from cross-format configuration contracts.
Existing prose/version/table debt remains pre-existing. Queue: next writing-python reforge.
