...
| `references/setup.md` | §3 install + project env + reproducibility + **§3.4 experiment management (DrWatson)** + TTFX, §5 running, §6 idioms, §7 output, §8 local-dev pointers | setting up Julia, running code, or managing reproducible experiments |
