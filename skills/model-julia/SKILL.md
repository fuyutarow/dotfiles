...
- [ ] If symbolic computation is involved: SymEngine.jl is used; Symbolics.jl is NOT, unless the task explicitly requires SciML integration (packages.md §4)
