...
- [`commanding-research-fleets`](commanding-research-fleets/) — Run a Director/PI/Researcher research fleet: role charters and prohibitions, the eight-item launch checklist, order-form shape, and the five stuck-question prompts — the fleet's operating manual, not programme/section state.
